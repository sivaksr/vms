                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Question 11</label>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Question 12</label>
                                    <select class="form-control" name="">
                                        <option value="" selected disabled>Select</option>
                                        <option value="">Answer 1</option>
                                        <option value="">Answer 2</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Question 13</label>
                                    <select class="form-control" name="">
                                        <option value="" selected disabled>Select</option>
                                        <option value="">Answer 1</option>
                                        <option value="">Answer 2</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Question 14</label>
                                    <select class="form-control" name="">
                                        <option value="" selected disabled>Select</option>
                                        <option value="">Answer 1</option>
                                        <option value="">Answer 2</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Question 15</label>
                                    <select class="form-control" name="">
                                        <option value="" selected disabled>Select</option>
                                        <option value="">Answer 1</option>
                                        <option value="">Answer 2</option>
                                ...
                                <a href="support.php" type="button" class="btn btn-primary next-step pull-right">Submit</a>
                            </div>
                            <br>
                        </div>
