    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <span class="pull-right"><a href="<?php echo base_url('contact/lists');?>" class="btn btn-primary btn-sm">Contacts List</a></span>
                <div class="clearfix">&nbsp;</div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" id="defaultForm" method="post" action="<?php echo base_url('contact/addpost');?>">
                            <div class="row">
                                <div class="col-md-6">
