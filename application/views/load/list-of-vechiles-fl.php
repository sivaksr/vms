...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="panel with-nav-tabs panel-default">
                    ...
                    <div class="col-md-9">
                        <div class="stepper">
                            <ul class="nav nav-tabs">
                               ...
                               <li role="presentation" class="completed">
                                    <a class="persistant-disabled" href="<?php echo base_url('load/material_type/'.base64_encode($load_id));?>" title="Step 3">
			...
			<?php if(isset($vechile_list) && count($vechile_list)>0){ ?>
			<div class="panel panel-default">
									...
									<?php foreach($vechile_list as $list){ ?>
                                                    ...
                                                    <tbody class="row">
                                                        <tr>
                                                            ...
                                                            <td class="bv-book col-md-1">
                                                                <a href="<?php echo base_url('load/orderconfirm/'.base64_encode($load_id).'/'.base64_encode($list['v_id']));?>" class="btn btn-md btn-warning">Book Now</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
