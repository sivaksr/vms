                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="panel  panel-default back-load">
                            <a class="" href="<?php echo base_url('load/full/'.base64_encode(1)); ?>">
                                <div class="panel-body">
                    ...
                    <div class="col-md-4">
                        <div class="panel  panel-default back-load">
                            <a class="" href="<?php echo base_url('load/full/'.base64_encode(2)); ?>">
                                <div class="panel-body">
                    ...
                    <div class="col-md-4">
                        <div class="panel  panel-default back-load">
                            <a class="" href="<?php echo base_url('load/box/'.base64_encode(3)); ?>">
                                <div class="panel-body">
