                ...
                <div class="tab-content">
                    <form action="" method="">
                                                    ...
                                                    <tbody class="row">
                                                        <tr>
                                                            <td class="bv-vechile-info col-md-2">
                                                                <p class="bvv-number"><?php echo isset($v_details['model_no'])?$v_details['model_no']:''; ?></p>
                                                                <div class="text-center">
                                                                    <i class="fa fa-truck fa-5x"></i>
                                                                    <br>
                                                                    <p class="bvv-name"><?php echo isset($v_details['rc_number'])?$v_details['rc_number']:''; ?></p>
                                                                </div>
                                                            </td>
                                                            <td class="bv-capacity col-md-2">
                                                                <p><i class="fa fa-balance-scale"></i> <?php echo isset($v_details['v_fuel_capacity'])?$v_details['v_fuel_capacity']:''; ?></p>
                                                            ...
                                                            <td class="bv-loading-dt col-md-2">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p class="pt-0"><?php echo isset($details['date'])?$details['date']:''; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                        ...
                        <ul class="list-inline pull-right">
                            <li><a href="<?php echo base_url('load/payment/'.base64_encode($load_id));?>" type="button" class="btn btn-primary next-step">Procced to Payment</a></li>
                        </ul>
                    </form>
                </div>
