    ...
    <div class="card col-md-4 " style="position:absolute; top: 50%; left: 50%; -webkit-transform: translate(-50%,-50%); -ms-transform: translate(-50%,-50%);transform: translate(-50%,-50%);">
        <div class="position:relative">
            <form class="text-center  p-5">
                ...
                <p class="h4 mb-4">Enter the OTP send to your phone number *******231</p>
                
                <!-- Email -->
                <input type="text" id="" class="form-control mb-4" placeholder="OTP">
                
                <!-- Sign in button -->
                <a href="<?php echo base_url('admin/submit');?>" class="btn btn-info btn-block my-4" type="submit">Next</a>
