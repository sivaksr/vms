    ...
    <section class="content">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="m-0 pull-left">Add Material type </h3>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form id="addvehicle" name="addvehicle" role="form" action="<?php echo base_url('material/addpost'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="material_type_name" name="material_type_name" placeholder="Enter Material type Name">
                                    </div>
                                    <!-- /.input group -->
                                </div> 
    ...
    $('#addvehicle').bootstrapValidator({
        fields: {
            material_type_img: {
                validators: {
					notEmpty: {
						message: 'Material type Image is required'
					},regexp: {
